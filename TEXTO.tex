...
\hfill\begin{minipage}{.8\textwidth}\itshape\baselineskip=1.4\baselineskip
...
\lettrine{A}{o finalizar as suas atividades diurnas}, o Rio de Janeiro apresentava o
...
\lettrine{P}{elo novo atalho} que tomaram, Bárbara deixou-se conduzir; não conhecia o
...
\lettrine{N}{a manhã seguinte}, Bárbara dormia profundamente quando a campainha do
...
curtos e escuros; o nariz adunco e a boca pequena de linhas firmes. Mrs.
...
\lettrine{A}{ fotografia mostrava um} homem de trinta anos. Moreno, feições enérgicas
...
\lettrine{S}{entada ali à} escrivaninha, Bárbara lembrava-se dessas cenas como se
...
--- E por que não lhe dizer a verdade? Eu estava mesmo num museu ---
tomou sorrindo.
...
\lettrine{--- E}{ram} cinco horas quando Bárbara e Helena pararam o automóvel ante
...
por que não persistir nos mesmos costumes? Não usavam eles o \emph{ph}, o
...
\lettrine{N}{o dia seguinte} Bárbara retornou aos seus hábitos. Acordou logo cedo e
...
\lettrine{N}{a tarde do} mesmo dia, Bárbara e Helena, em uma confeitaria central,
...
\lettrine{À}{ noite, }Bárbara, no hotel, dirigiu-se ao salão de leitura. Desde que
...
\lettrine{D}{epois de um} passeio demorado à Cascatinha da Tijuca, cantada nos versos
...
\lettrine{O}{ Cassino da} Urca estava repleto. Um vai e vem de pessoas, entre a sala
...
\lettrine{D}{ona Julieta} olhou indignada para a amiga e, num
...
\lettrine{E}{stavam todos à} mesa quando Carlito chegou ao cassino. No grupo onde se
...
\lettrine{A}{ luz entrava em} cheio pela janela aberta e ia bater no rosto de
...
\lettrine{N}{a manhã seguinte}, Bárbara, ao sair do elevador, tornou a ver Carlito. O
...
\lettrine{O}{ avião levantou voo} no aeroporto Santos Dumont, e, em breve, a cidade
...
\lettrine{E}{ram cinco e} meia da tarde.
...
\lettrine{D}{e quando em} quando, um marinheiro passava pelo tombadilho; depois, tudo
recaía na solidão.
...
\lettrine{B}{árbara sentou-}se perto do rádio, na sala de leitura. Abriu a revista e
...
\lettrine{N}{a manhã seguinte}, os passageiros, mais acostumados ao mar, deixaram as
...
\lettrine{O}{ vapor anunciava a} sua chegada ao Rio. Os sinais de terra fizeram-se
...
\lettrine{B}{árbara entrou na} sua casa, a terceira que possuíra na vida. Tudo lhe
...
\lettrine{N}{o dia seguinte}, logo após o almoço, Bárbara desencaixotava os livros na
...
\lettrine{C}{omo prometera à} Helena, Bárbara foi, à noite, para a casa da amiga.
...
\lettrine{N}{o dia seguinte}, Álvaro reaparecia na casa de Bárbara à mesma hora. Como
...
\lettrine{B}{árbara levantou-}se cedo e, após o café, saiu para o jardim. A manhã
...
\lettrine{A}{ janela do quarto} estava aberta; os primeiros raios da alvorada
...
\lettrine{C}{arlito despediu-}se contrariado. Que criatura estranha era Bárbara. Já,
...
\lettrine{V}{eio a outra} semana e Bárbara não teve notícias de Álvaro. Sem dizer por
...
\lettrine{A}{ frescura da manhã}, o passeio pela cidade e a expectativa de um banho
...
\lettrine{B}{árbara estava só} e tudo indicava que aquele dia seria um dois muitos da
...
\lettrine{B}{árbara não fora} ao chá de Ivete, mas combinara com Helena, fazer-lhe
...
\lettrine{O}{ tempo mudou de} repente e Bárbara chegou em casa sob um temporal
...
\lettrine{H}{ouve um silêncio} prolongado. Após sua inesperada revelação, Álvaro
...
\lettrine{Á}{lvaro retirou-}se tarde. Tendo fechado a porta, Bárbara moveu-se pela
...
\lettrine{B}{árbara combinara com} Álvaro o seu primeiro passeio. Ia tentar
...
\lettrine{Á}{lvaro chegara em} casa, profundamente emocionado. Separara-se de Bárbara
...
\lettrine{--- H}{elena}! --- exclamou Bárbara satisfeita.
...
\lettrine{P}{rimeiro poste da} esquina... Bárbara lembrou se de Álvaro. Com que
...
\lettrine{C}{om o andar} já meio cansado, Álvaro percorria as ruas da cidade sob o
...
\lettrine{Q}{uando Álvaro} voltou à casa de Bárbara, no dia seguinte, estava já
...
\lettrine{M}{eia-noite}. Da casa de d\textsuperscript{a}. Alda saíam alguns
...
\lettrine{A}{os poucos,} Álvaro ia penetrando mais na intimidade de Bárbara. Vinha
...
\lettrine{Q}{uando Álvaro} se retirou, Bárbara, mais à vontade, entregou-se aos seus
...
\lettrine{D}{ias depois,} Bárbara examinava os heliotrópios que Álvaro semeara,
...
\lettrine{S}{em que }Bárbara esperasse, Helena apareceu em sua casa à hora do almoço.
...
\lettrine{C}{omo prometera a} Bárbara, naquela mesma tarde de fins de março, Lia
...
\lettrine{C}{arlito parara a} sua linda barata em frente à casa de Bárbara. Sua
...
\lettrine{Á}{lvaro, no} seu quartinho humilde, pensava nos últimos acontecimentos.
...
\lettrine{E}{ra noite adiantada}. O silêncio da cidade indicava a hora de repouso. No
...
\lettrine{C}{arlito parou o} carro em frente à residência de Bárbara. A moça desceu,
...
\lettrine{N}{a manhã seguinte}, Bárbara foi atender pessoalmente à porta. Mal a
...
\lettrine{P}{aulo retirou-}se. Bárbara e Álvaro, no terraço da casa, contemplaram-no
...
\lettrine{U}{m concerto estava} marcado para aquela noite. Um artista de renome
...
\lettrine{L}{ia ainda quis} dizer qualquer coisa a Ivete. Criança demais para ter
...
\lettrine{A}{ lagoa Rodrigo} de Freitas foi a seguir o local escolhido. Álvaro e
...
\lettrine{D}{ezenove de }Abril. Dia do casamento.
...
\lettrine{D}{r.~Rocha} acompanhou a pequena com o olhar. Viu-a regressar ao grupo e
...
\lettrine{``C}{omparam-se os homens...''} O primeiro livro de Álvaro vinha à luz.
...
um cartaz contava ao público que o autor de ``\textsc{comparam-se os homens}
...
\lettrine{Á}{lvaro e }Bárbara, nos últimos tempos, quase não passeavam silenciosos. A
...
\lettrine{A}{o sair das} meditações a que se entregaram, viram que era já noite
...
\lettrine{O}{lharam em redor}. A calma era quase absoluta. Voltaram ao restaurante;
...
\lettrine{Q}{uando Álvaro} adormeceu era quase dia. E a noite correu vagarosa,
...
\lettrine{A}{bsorvida nos seus} pensamentos, Bárbara deixou passar as horas. Só
...
\lettrine{D}{ias depois,} Bárbara dirigiu-se ao Pão de Açúcar. Ao sair do bonde, o
...
\textsc{hoje: beethoven --- nona sinfonia}
\medskip
...
Começava \emph{o} adágio da nona sinfonia; página de recolhimento,
...
\lettrine{P}{elas dificuldades que} surgiram, Álvaro fazia a sua viagem
...
\lettrine{Q}{uando Helena} voltou à casa de Bárbara, o seu casamento já estava
...
\lettrine{M}{anhã ainda;} Bárbara, de calças a jardineira, cuidava das plantas. Os
...
balanço de madeira. Olhando para o lado, viu ``\textsc{comparam-se os homens}'', o
...
\lettrine{O}{nze horas da} noite. Todos se retiraram; Bárbara andou pela casa vazia.
...
\lettrine{P}{assaram-se} os dias e Bárbara continuou sem notícias de Álvaro. Setembro
...
\lettrine{B}{árbara deixou o} telefone e foi atender a porta. Ao abri-la, com grande
...
\lettrine{E}{ntre eles caiu} um silêncio de angústia. Paulo voltou a sentar-se na
...
\lettrine{C}{hegou o dia} treze. Era o dia do casamento de Helena. Bárbara começara o
...
\lettrine{H}{elena atravessara a} sala de música. Separando-se de Bárbara,
...
\lettrine{B}{árbara estava no} terraço, quando Álvaro abriu o portãozinho de ferro.
...
\lettrine{N}{a manhã seguinte}, Álvaro e Bárbara foram à praia de Copacabana.
...
\lettrine{E}{ra noite.} Bárbara pôs o casaquinho sobre os ombros e saiu com Álvaro.
...
\lettrine{E}{ram quase dez} horas quando deixaram o hospital. A noite agradável
...
\lettrine{Á}{lvaro e }Bárbara não se encontravam com a mesma frequência de antes. Há
...
\lettrine{--- B}{árbara} --- chamou a governanta, entrando na sala.
...
\lettrine{Á}{lvaro terminava o} seu segundo trabalho. A convivência com Bárbara e o
...
``\textsc{tem a sociedade moderna direitos de crítica ao divórcio}?''.
...
\lettrine{A}{ entrega ao editor}, do seu segundo livro, permitiu a Álvaro a procura
...
\lettrine{B}{árbara sentou-}se à escrivaninha e diante de si, pôs o trabalho
...
\emph{Um beijo da amiga afeiçoada,}\medskip

\hfill Helena

\hfill {31 de Outubro de 1938.}
\end{quote}
...
\lettrine{A}{ campainha do portão} vibrou com força; e logo a seguir entrou na sala
...
\lettrine{Á}{lvaro passara parte} da noite no jornal. Inaugurara-se uma exposição de
...
\lettrine{Q}{uando Álvaro} regressou à pensão, já havia passado a hora do jantar.
...
\hfill \emph{Inteiramente ao seu dispor}
...
\lettrine{Á}{lvaro conseguira vencer} os dias sem retornar a Santa Tereza. A cena do
...
Encostou-se à parede e, com as mãos no bolso, começou:\medskip
...
\hspace{2em} \emph{Todo o mundo ao redor já a perdeu e te culpa;}\\
\emph{De crer em ti quando todos estão duvidando;}\\
\hspace{2em} \emph{E para esses no entanto achar uma desculpa.}\\
\emph{Se és capaz de esperar} sem \emph{te desesperares}\\
\hspace{2em} \emph{Ou enganado, não mentir ao mentiroso}\\
\emph{Ou sendo odiado sempre ao ódio te esquivares,}\\
\hspace{2em} \emph{E não parecer bom demais nem pretensioso;}\\!

\emph{Se és capaz de pensar} --- \emph{sem que a isso só te atires;}\\
\hspace{2em} \emph{De sonhar} --- \emph{sem fazeres dos sonhos teus senhores}\\
\emph{Se encontrando a Desgraça e o Triunfo conseguires}\\
\hspace{2em} \emph{Tratar da mesma forma a esses dois impostores}\\
\emph{Se és capaz de sofrer a dor de ver mudadas}\\
\hspace{2em} \emph{Em armadilhas as verdades que disseste,}\\
\emph{E as coisas por que deste a vida, estraçalhadas,}\\
\hspace{2em} \emph{E refazê-las com o bem pouco que te reste.}\\!

\emph{Se és capaz de arriscar numa única parada}\\*
\hspace{2em} \emph{Tudo quanto ganhaste em toda a tua vida}\\*
\emph{E perder, e ao perder, sem nunca dizer nada}\\*
\hspace{2em} \emph{Resignado, tornar ao ponto de partida,}\\
\emph{De forçar o coração, nervos, músculos, tudo,}\\
\hspace{2em} \emph{A dar seja o que for que neles} \emph{ainda existe}\\
\emph{E a partir assim quando, exaustos, contudo}\\
\hspace{2em} \emph{Resta a vontade em ti que ainda ordena:} ``\emph{Persiste''.}\\!

\emph{Se és capaz de entre a plebe, não te corromperes}\\
\hspace{2em} \emph{E entre reis não perder a naturalidade,}\\
\emph{E de amigos, quer bons quer maus, te defenderes}\\
\hspace{2em} \emph{Se a todo}s \emph{podes ser de alguma utilidade}\\
\emph{E} se \emph{és capaz de dar, segundo por segundo,}\\
\hspace{2em} \emph{Ao minuto fatal todo o valor e brilho}\\
\emph{Tua é a terra com tudo o que existe no mundo}\\
\hspace{2em} \emph{E} --- \emph{o que mais} --- \emph{tu serás um homem, ó meu
filho!}
\end{verse}
...
\lettrine{A}{s manhãs de} dezembro estavam esplêndidas. Bárbara levantou-se muito
...
\lettrine{Á}{lvaro tinha deixado} a casa de Bárbara, naquela manhã, com uma esperança
...
\lettrine{E}{ra o dia} da colação de grau. Vinte e dois de dezembro de mil novecentos
...
\lettrine{B}{árbara e }Álvaro voltaram para a casa, silenciosos. A morte de Dalila
...
\lettrine{Á}{lvaro chegou a} São Paulo e dedicou-se inteiramente às suas atividades.
...
\lettrine{M}{il novecentos e} trinta e nove parecia cheio de promessas. Assim Bárbara
...
\lettrine{C}{om uma conferência} de despedida, Álvaro concluiu o seu trabalho na
...
\lettrine{À}{s dez horas}, já estavam os convidados no clube. Álvaro foi o último a
...
\lettrine{B}{árbara recebeu o} telegrama e leu-o com alegria. Ao voltar-se, viu o
...
\lettrine{A}{ despedida não durou} uma noite. Passou-se uma semana, e Álvaro
...
\lettrine{O}{ salão do }Esplanada resplandecia. Todas as luzes, acesas, refletiam-se
...
\lettrine{S}{e janeiro começara} cheio de promessas, fevereiro não prognosticava as
...
\lettrine{Á}{lvaro chegava ao} hotel já irritado. As mínimas coisas o faziam perder a
...
\lettrine{P}{aulo, }Helena e Álvaro foram jantar num restaurante da cidade.
...
\lettrine{Q}{uando Paulo} veio à procura de Álvaro pela manhã, encontrou-o ainda do
...
para mim. Você querida, é a minha filosofia...\bigskip
